...
class BulkProducts(models.Model):
    ...
    # bulk_products_ids = fields.One2many("bulk.product.line", "bulk_product_id", string=_("Bulk Products"))
    bulk_products_id = fields.One2many("product.product", domain="[('type', '=', 'product')]", string=_("Products"))
